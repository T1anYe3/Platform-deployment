#!/bin/sh
# Initialize Elasticsearch ILM policies and index templates
...
create_ilm_policy "safeline-records" 30 60 90
create_ilm_policy "suricata-alerts" 30 60 90
create_ilm_policy "vault-audit" 30 90 180
create_ilm_policy "minio-audit" 30 90 180
create_ilm_policy "nifi-logs" 30 90 180
