#!/usr/bin/env python3
"""Generate GB-scale test data for Platform 2 benchmark testing.
...
def main():
    parser = argparse.ArgumentParser(description='Generate Platform 2 benchmark test data')
    parser.add_argument('--output-dir', default='/tmp/platform2-benchmark-data',
